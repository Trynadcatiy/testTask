...
insert into restaurant (id,name,legalName,inn,adress,guest_id) values (  1,'Первый ресторан','ООО "Первый"','7002001001','Адрес 1/1',1);
insert into restaurant (id,name,legalName,inn,adress,guest_id) values (  2,'Второй ресторан','ООО "Второй"','7002001002','Адрес 2/2',4);
insert into restaurant (id,name,legalName,inn,adress,guest_id) values (  3,'Третий ресторан','ООО "Третий"','7002001003','Адрес 3/3',2);
insert into restaurant (id,name,legalName,inn,adress,guest_id) values (  4,'Четвертый ресторан','ООО "Четвертый"','7002001004','Адрес 4/4',3);
insert into restaurant (id,name,legalName,inn,adress,guest_id) values (  5,'Пятый ресторан','ООО "Пятый"','7002001005','Адрес 5/5',3);

insert into guest (id,firsName,lastlName,email,telNum,restaurant_id) values (  1,'Имя1','Фамилия1','one@temp.ru','79003002001',5);
insert into guest (id,firsName,lastlName,email,telNum,restaurant_id) values (  2,'Имя2','Фамилия2','two@temp.ru','79003002002',4);
insert into guest (id,firsName,lastlName,email,telNum,restaurant_id) values (  3,'Имя3','Фамилия3','three@temp.ru','79003002003',3);
insert into guest (id,firsName,lastlName,email,telNum,restaurant_id) values (  4,'Имя4','Фамилия4','four@temp.ru','79003002004',2);
